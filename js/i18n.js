...
const I18N = {
  ...
  ms: {
    nav_overview: 'Gambaran', nav_dashboard: 'Papan Pemuka', nav_transactions: 'Transaksi',
    nav_wealth: 'Kekayaan', nav_investments: 'Pelaburan', nav_goals: 'Matlamat',
    nav_insights: 'Wawasan', nav_analytics: 'Analitik', nav_reports: 'Laporan',
    nav_ai: 'Pembantu AI', nav_system: 'Sistem', nav_settings: 'Tetapan',
    hdr_total_year: 'Jumlah Tahun',
    dash_subtitle: 'Gambaran kewangan',
    dash_income: 'Pendapatan', dash_expense: 'Perbelanjaan', dash_savings: 'Simpanan',
    dash_no_data: 'Tiada data kewangan untuk', dash_no_change: 'Tiada perubahan',
    txn_search: 'Cari...', txn_add: 'Tambah', txn_count: 'Bilangan', txn_net: 'Bersih',
    ...
    set_pk_wrong: '❌ Salah', set_pk_min: '❌ Min 4 aksara', set_pk_ok: '✅ Dikemaskini',
  ...
  id: {
    nav_overview: 'Ikhtisar', nav_dashboard: 'Dasbor', nav_transactions: 'Transaksi',
    ...
    txn_search: 'Cari...', txn_add: 'Tambah', txn_count: 'Jumlah', txn_net: 'Bersih',
    txn_date: 'Tanggal', txn_type: 'Jenis', txn_category: 'Kategori',
    txn_sub: 'Sub', txn_details: 'Detail', txn_amount: 'Jumlah', txn_actions: 'Aksi',
    txn_no_found: 'Tidak ada transaksi ditemukan untuk',
    txn_add_title: 'Tambah Transaksi', txn_edit_title: 'Edit Transaksi',
    txn_cascade: 'Jenis → Kategori → Subkategori',
    txn_cancel: 'Batal', txn_save: 'Simpan', txn_update: 'Perbarui',
    txn_added: '✅ Ditambahkan', txn_updated: '✅ Diperbarui', txn_deleted: '🗑 Dihapus',
    set_title: 'Pengaturan', set_sub: 'Preferensi, keamanan, akun',
    set_general: 'Umum', set_security: 'Keamanan', set_currency: 'Mata Uang',
    set_language: 'Bahasa', set_dark_mode: 'Mode Gelap', set_theme: 'Tema',
    set_notifications: 'Notifikasi', set_budget_alerts: 'Peringatan anggaran',
  ...
  ko: {
    nav_overview: '개요', nav_dashboard: '대시보드', nav_transactions: '거래',
    nav_wealth: '자산', nav_investments: '투자', nav_goals: '목표',
    nav_insights: '인사이트', nav_analytics: '분석', nav_reports: '보고서',
    nav_ai: 'AI 어시스턴트', nav_system: '시스템', nav_settings: '설정',
    hdr_total_year: '연간 합계',
    dash_subtitle: '재정 개요',
    dash_income: '수입', dash_expense: '지출', dash_savings: '저축',
    dash_no_data: '이용 가능한 재정 데이터가 없습니다', dash_no_change: '변동 없음',
    txn_search: '검색...', txn_add: '추가', txn_count: '건수', txn_net: '순액',
    txn_date: '날짜', txn_type: '유형', txn_category: '카테고리',
    txn_sub: '하위', txn_details: '상세', txn_amount: '금액', txn_actions: '작업',
    txn_no_found: '거래를 찾을 수 없습니다',
    txn_add_title: '거래 추가', txn_edit_title: '거래 수정',
    txn_cancel: '취소', txn_save: '저장', txn_update: '업데이트',
    txn_added: '✅ 추가됨', txn_updated: '✅ 업데이트됨', txn_deleted: '🗑 삭제됨',
    set_title: '설정', set_sub: '환경설정, 보안, 계정',
    set_general: '일반', set_security: '보안', set_currency: '통화',
  ...
  ru: {
    nav_overview: 'Обзор', nav_dashboard: 'Панель', nav_transactions: 'Транзакции',
    nav_wealth: 'Богатство', nav_investments: 'Инвестиции', nav_goals: 'Цели',
    nav_insights: 'Аналитика', nav_analytics: 'Анализ', nav_reports: 'Отчёты',
    ...
    dash_no_data: 'Нет финансовых данных за', dash_no_change: 'Без изменений',
    txn_search: 'Поиск...', txn_add: 'Добавить', txn_count: 'Кол-во', txn_net: 'Нетто',
    txn_date: 'Дата', txn_type: 'Тип', txn_category: 'Категория',
    txn_sub: 'Суб', txn_details: 'Детали', txn_amount: 'Сумма', txn_actions: 'Действия',
    txn_no_found: 'Транзакции не найдены за',
    txn_add_title: 'Добавить транзакцию', txn_edit_title: 'Редактировать',
    txn_cancel: 'Отмена', txn_save: 'Сохранить', txn_update: 'Обновить',
    txn_added: '✅ Добавлено', txn_updated: '✅ Обновлено', txn_deleted: '🗑 Удалено',
    set_title: 'Настройки', set_sub: 'Параметры, безопасность, счета',
    set_general: 'Общие', set_security: 'Безопасность', set_currency: 'Валюта',
