...
function renderInvestments(c) {
  ...
  c.innerHTML = '<div class="inv-page">' +
    '<div class="inv-section"><div class="kg inv-kpi">' +
      '<div class="kc bl"><div class="kc-left"><div class="kc-hdr"><div class="ki"><i data-lucide="briefcase" width="14" height="14"></i></div><div class="kl">' + t('inv_portfolio') + '</div></div><div class="kv">' + fmt(portfolio) + '</div></div></div>' +
      '<div class="kc gd"><div class="kc-left"><div class="kc-hdr"><div class="ki"><i data-lucide="piggy-bank" width="14" height="14"></i></div><div class="kl">' + t('goal_actual_spent') + '</div></div><div class="kv">' + fmt(invested) + '</div></div></div>' +
      '<div class="kc ' + (isGain ? 'em' : 'rs') + '"><div class="kc-left"><div class="kc-hdr"><div class="ki"><i data-lucide="' + (isGain ? 'trending-up' : 'trending-down') + '" width="14" height="14"></i></div><div class="kl">P&L</div></div><div class="kv" style="color:var(' + (isGain ? '--emerald' : '--rose') + ')">' + (isGain ? '+' : '') + fmt(pnl) + '</div></div></div>' +
      '<div class="kc ' + (isGain ? 'gn' : 'rs') + '"><div class="kc-left"><div class="kc-hdr"><div class="ki"><i data-lucide="percent" width="14" height="14"></i></div><div class="kl">Return</div></div><div class="kv" style="color:var(' + (isGain ? '--emerald' : '--rose') + ')">' + (isGain ? '+' : '') + returnPct.toFixed(2) + '%</div></div></div>' +
