...
function renderGoals(c) {
  ...
  html += `<div style="background:var(--bg-card);border:1px solid var(--border);border-radius:10px;overflow:hidden;margin-bottom:20px"><table style="width:100%;border-collapse:collapse;font-size:11px;min-width:0;table-layout:fixed"><thead><tr style="background:var(--bg-primary)"><th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:600;color:var(--text-secondary);width:22%">Month</th><th style="padding:8px 6px;text-align:right;font-size:9px;font-weight:600;color:var(--emerald);width:22%">Income</th><th style="padding:8px 6px;text-align:right;font-size:9px;font-weight:600;color:var(--rose);width:22%">Expense</th><th style="padding:8px 6px;text-align:right;font-size:9px;font-weight:600;color:var(--blue);width:22%">Savings</th><th style="padding:8px 4px;text-align:center;width:12%"></th></tr></thead><tbody>`;
  MD.forEach((m, idx) => {
